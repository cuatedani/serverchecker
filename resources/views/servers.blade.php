<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        @forelse ($servers as $server)
                        ...
                        <table class="table-auto w-full">
                            ...
                            <tr>
                                ...
                                <td class="py-2 text-center flex justify-center items-center">
                                    ...
                                    <x-danger-button class="text-red-500 hover:text-red-700 ml-2 btn-delete" data-server-id="{{ $server->id }}">
                                            {{ __('Eliminar') }}
                                        </x-danger-button>
                                </td>
                            </tr>
            ...
            @endif
        @empty
            <p class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">No hay servidores
                disponibles</p>
        @endforelse
    </div>
